    ...
    <div
      ...
      max-w-md w-full ${
        type == '0'
          ...
          ? 'bg-[#eab90f]'
          : 'bg-[#e13f32]'
      } shadow-lg rounded-lg-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
    >
      ...
      <div className="flex">
        <button
          ...
          type="button"
          className="mr-2 box-content rounded-lg-none border-none opacity-100 hover:no-underline hover:opacity-50 focus:opacity-50 focus:shadow-none focus:outline-none text-white"
