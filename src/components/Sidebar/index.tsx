...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const hasShowUsers = usePermissions('user_show');
  const hasShowRoles = usePermissions('role_show');
  const hasShowPermissions = usePermissions('permission_show');
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute bg-white shadow-lg left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/specialities"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === '/speciality' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/lesson-type"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === '/lesson-type' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/smestrs"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === '/smestrs' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/weeks-types"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === '/weeks-types' && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
