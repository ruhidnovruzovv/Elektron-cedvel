          ...
          <form>
            <div className="grid grid-cols-3 gap-5 justify-normal">
              <div className="form-group w-full col-span-3">
                ...
                <input
                  className="w-full rounded-lg border border-stroke bg-gray py-3 pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                  name="id"
              ...
              <div className="form-group ">
                ...
                <div className="relative z-20 w-full rounded-lg border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
                  <span className="m-1.5 flex items-center justify-center rounded-lg border-[.5px] border-stroke bg-gray py-1.5 px-2.5 text-sm font-medium dark:border-strokedark dark:bg-white/30">
                    {formState.para}
                  </span>
                  <select
                  ...
                  <span
                    className={`${
                      formState.type == 0
                        ...
                        ? 'bg-[#eab90f]'
                        : 'bg-[#e13f32]'
                    } m-1.5 flex items-center justify-center rounded-lg border-[.5px] border-stroke py-1.5 px-2.5 text-white font-medium dark:border-strokedark`}
                  >
                    {formState.type == 0
                      ? 'Info'
                      : formState.type == 1
            ...
            <br></br>
            <button
              className="btn flex justify-center rounded-lg bg-primary py-2 px-6 font-medium text-gray hover:shadow-1"
              type="submit"
